...
using namespace std;
        ...
        {
            if (DEBUGl3)
                cout << "Resizing index from " << wordListCapacity
                    << " to " << (wordListCapacity + 10) << endl;
        ...
        /**
         * overloaded consturctor, initizes and declares variables
         *
         *
         */
        ...
        /**
         * constructor, initilizes and declares variables
         *
         *
         */
        MyIndex::MyIndex()
        ...
        /**
         * deconstructor, delete's variables
         *
         *
         */
        MyIndex::~MyIndex()
        ...
        /**
         * checks if the passes char[] is in the the index
         *
         *returns bool
         */
            ...
            for (int i = 0; i < wordListSize; i++)
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < numPages; i++)
                    {
                        ...
                        if(i != numPages - 1) //don't put a comma after the last page number
                            strcat(tempOutput, ", ");
                    }
